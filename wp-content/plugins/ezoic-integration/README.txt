...
= 2.8.28 =
* Ability to block placeholders on specific URLs
* Minor bug fixes
...
= 2.8.10 =
* Minor bug fixes for microdata annotation
...
= 2.8.5 =
* Implement revenue date filter for placeholders
* Fixed removal of ads.txt redirection
